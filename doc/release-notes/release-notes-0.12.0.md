...
Then, to tunnel a SSL connection on 28356 to a RPC server bound on localhost on port 18356 do:

    stunnel -d 28356 -r 127.0.0.1:18356 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:8356/
        ProxyPassReverse http://127.0.0.1:8356/
