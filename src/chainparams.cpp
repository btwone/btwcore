...
public:
    CMainParams() {
        ...
        consensus.BTGHeight = 499777; // Around 12/18/2017 04:26 UTC
        consensus.BTWLastSubsidy = 714000; // preserve 2,100,000
        consensus.BTGPremineWindow = 10;
        consensus.BTGPremineEnforceWhitelist = true;
        consensus.BitcoinPostforkBlock = uint256S("000000000000000000044027faba06b6e0770d5d33b41ffd6d864c56d3561adc");
        consensus.BitcoinPostforkTime = 1513512677;
        consensus.powLimit = uint256S("000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.powLimitStart = uint256S("0000003fffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        nDefaultPort = 8357; // different port than Bitcoin
        ...
        vSeeds.emplace_back("dnsseed.btw.one", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,73);  // prefix: W
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,31);  // prefix: D
...
public:
    CTestNetParams() {
        ...
        consensus.BTGHeight = 20161;
        consensus.BTWLastSubsidy = 714000; // preserve 2,100,000
        consensus.BTGPremineWindow = 10;
        consensus.BTGPremineEnforceWhitelist = false;
        consensus.BitcoinPostforkBlock = uint256S("000000002dee3219e62f3eeef174d2988c3d6e0cd225e87f72092d990265c792");
        //consensus.BitcoinPostforkBlock = uint256S("00000000ef93c2d9bac8da61ff11a699a5b815f77a194c567c5de0dbdf0bf28b");
        consensus.BitcoinPostforkTime = 1511964288;
        ...
        vSeeds.emplace_back("test-dnsseed.btw.one", true);
